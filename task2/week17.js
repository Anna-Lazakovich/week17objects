...
data.forEach((element) => {
    ...
    if (element.type === "car") {
        const car = new Car(element.type = "Автомобиль", element.price, element.brand, element.doors);
        ...
        const bike = new Bike(element.type = "Мотоцикл", element.price, element.brand, element.maxSpeed);
    ...
    transportImage.src = element.image;
